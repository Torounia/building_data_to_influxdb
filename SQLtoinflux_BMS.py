...
def convert_to_float(x):
    try:
        ...
        return float( '0' if x == 'OFF' else '1')
...
for row in range(len(datapoint_time)):
    influx_points.append(
        ...
        "tags": {
            ...
            "device_location_area": 'N/A' if 'external' in device_location[row] else device_location[row].split('_')[2],
        ...
        "fields": {
            "value": convert_to_float(datapoint_value[row]), #https://stackoverflow.com/questions/37472361/how-do-i-check-if-a-string-is-a-negative-number-before-passing-it-through-int
            }
    })
